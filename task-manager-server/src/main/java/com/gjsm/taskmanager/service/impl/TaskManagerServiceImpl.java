	...
	private JdbcTemplate jdbcTemplate;
		...
		public void addTask(Tasks task){
			...
			try {
				...
				String sql = "INSERT INTO tasks(parent_id,task,start_date,end_date,priority,status) "
		...
		public List<Tasks> deleteTask(int task_id) {
			 String updateTaskQry = "update tasks set status='inactive' where task_id =? ";
		...
		public void editTask(Tasks task) {
			 String updateTaskQry = "update tasks set task =?, priority=?, start_date=?, end_date=? where task_id =? ";
		...
		public List<Tasks> getAllTasks() {
			String query = "select t.task_id,t.task,t.priority,t.start_date,t.end_date, t.status,pt.parent_task,pt.parent_id as parentTaskId from tasks t left join parent_task pt on t.parent_id=pt.parent_id";
